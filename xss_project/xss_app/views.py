...
def xss_vulnerable(request):
    if request.method == 'POST':
        ...
        return render(request, 'C:/Users/angel/xss_project/xss_app/templates/xss_result.html', {'result': user_input, 'sanitized': False})
    return render(request, 'C:/Users/angel/xss_project/xss_app/templates/xss_form.html')
